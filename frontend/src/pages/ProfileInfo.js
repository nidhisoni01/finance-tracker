...
export default function ProfileInfo() {
  return (
    <div className="p-8 bg-gray-50 dark:bg-black min-h-screen max-w-xl mx-auto">
      ...
      <h1 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white">Edit Profile Info</h1>
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow p-6 flex flex-col gap-4">
        <div className="text-gray-500 dark:text-gray-400">Profile editing coming soon...</div>
      </div>
    </div>
  );
} 